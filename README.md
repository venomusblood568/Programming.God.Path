...
| Find the Factorial of a large number                     | [Link](https://leetcode.com/problems/factorial/) | Medium           | [ ]  |
...
| Delete last occurrence of an item from linked list        | [Link](https://leetcode.com/problems/remove-duplicates-from-sorted-list-ii/) | Easy             | [ ]  |
...
| Egg Dropping Puzzle                                       | [Link](https://leetcode.com/problems/egg-drop-with-2-eggs-and-n-floors/) | Hard             | [ ]  |
| Matrix Chain Multiplication                               | [Link](https://leetcode.com/problems/minimum-score-triangulation-of-polygon/) | Medium           | [ ]  |
...
| Problem                                                   | LeetCode Link                               | Difficulty Level | Done |
|-----------------------------------------------------------|---------------------------------------------|------------------|------|
| Sentence Palindrome                                       | [Link](https://leetcode.com/problems/valid-palindrome-ii/) | Easy             | [ ]  |
...
| Bridges in a graph                                        | [Link](https://leetcode.com/problems/critical-connections-in-a-network/) | Medium           | [ ]  |
| Check whether a given graph is Bipartite or not           | [Link](https://leetcode.com/problems/is-graph-bipartite/) | Medium           | [ ]  |
| Find size of the largest region in Boolean Matrix         | [Link](https://leetcode.com/problems/max-area-of-island/) | Medium           | [ ]  |
| Flood fill Algorithm                                      | [Link](https://leetcode.com/problems/flood-fill/) | Medium           | [ ]  |
| Strongly Connected Components                             | [Link](https://leetcode.com/problems/strongly-connected-components/) | Medium           | [ ]  |
